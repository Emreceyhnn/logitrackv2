...
mock.module("@/app/lib/controllers/shipments", { namedExports: shipmentsControllerMock });
mock.module("@/app/lib/language/DictionaryContext", { namedExports: dictContextMock });
