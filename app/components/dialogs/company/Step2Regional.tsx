      ...
      <Stack spacing={4}>
        <Box>
          ...
          <FormControl fullWidth error={touched.timezone && !!errors.timezone}>
            <Select
              ...
              startAdornment={
                <PublicIcon
                  sx={{ mr: 1, color: theme.palette.text.primary_alpha.main_30, fontSize: 20 }}
                />
              }
              sx={{
        ...
        >
          ...
          <Box>
            ...
            <Typography
              variant="caption"
              sx={{ color: theme.palette.text.secondary_alpha.main_70, display: "block", mb: 2, lineHeight: 1.5 }}
            >
