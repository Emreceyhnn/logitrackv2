...
import { alpha, Avatar, Box, Button, Chip, Dialog, DialogContent, Divider, IconButton, Stack, Tab, Tabs, Typography, useTheme } from "@mui/material";
...
const DriverDialog = (params: DriverDialogParams) => {
    ...
    const statusColor = (theme.palette as any)[colorKey]?.[colorVariant] || theme.palette.text.primary;
