    ...
    >
      ...
      <Box sx={{ p: 3, pb: 2 }}>
        <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
          ...
          <IconButton
            onClick={onClose}
            size="small"
            sx={{ color: (theme.palette.common as any).white_alpha.main_30, "&:hover": { color: "white" } }}
            disabled={loading}
          >
      ...
      <Box
        sx={{
          p: 3,
          pt: 2,
          bgcolor: (theme.palette.background as any).default_alpha.main_10,
        ...
        <Stack direction="row" spacing={2} justifyContent="flex-end">
          ...
          <Button
            ...
            sx={{
              ...
              fontWeight: 700,
              minWidth: 100,
              boxShadow: `0 8px 24px ${(theme.palette.error as any)._alpha.main_20}`,
              "&:hover": {
                bgcolor: theme.palette.error.dark,
                boxShadow: `0 12px 32px ${(theme.palette.error as any)._alpha.main_30}`,
              },
            }}
          >
