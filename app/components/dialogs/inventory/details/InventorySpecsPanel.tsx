...
import { Box, Stack, Paper, Typography, Avatar, Grid, useTheme } from "@mui/material";
import {
  Scale as ScaleIcon,
...
interface InventorySpecsPanelProps {
  item: InventoryWithRelations;
  otherLocations: InventoryWithRelations[];
}

/** Right column of the inventory details overview: physical specs + intel. */
export default function InventorySpecsPanel({
  item,
  otherLocations,
}: InventorySpecsPanelProps) {
    ...
    <Box sx={{ p: 4 }}>
      ...
      <Grid container spacing={3} mt={1}>
        <Grid size={{ xs: 12, sm: 4 }}>
          ...
          >
            <ScaleIcon sx={{ color: "primary.main", mb: 1.5, fontSize: 32 }} />
        ...
        <Grid size={{ xs: 12, sm: 4 }}>
          ...
          >
            <VolumeIcon sx={{ color: "secondary.main", mb: 1.5, fontSize: 32 }} />
            <Typography variant="caption" display="block" color="text.secondary">
        ...
        <Grid size={{ xs: 12, sm: 4 }}>
          ...
          >
            <PalletIcon sx={{ color: "success.main", mb: 1.5, fontSize: 32 }} />
            <Typography variant="caption" display="block" color="text.secondary">
