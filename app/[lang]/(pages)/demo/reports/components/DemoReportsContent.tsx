...
import { useDemoReportsData } from "@/app/hooks/demo/useDemoReports";
...
/**
 * Demo-only counterpart to ReportsContent — identical read-only tabs/charts
 * layout. The real page has no mutations; the only change here is the data
 * hook swap to useDemoReportsData.
 */
export default function DemoReportsContent() {
  const dict = useDictionary();
  const { state, actions } = useDemoReportsData();
