...
import { useDemoOverview } from "@/app/hooks/demo/useDemoOverview";
...
export default function DemoOverviewContent() {
  /* -------------------------------- VARIABLES ------------------------------- */
  ...
  /* ---------------------------------- HOOKS --------------------------------- */
  const { data, isLoading, isError, refetch } = useDemoOverview();
  ...
  const kpiItems = useMemo(() => {
    const shipmentsBase = buildLocalizedHref("/demo/shipments", lang);
