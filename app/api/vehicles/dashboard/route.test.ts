...
mock.module("@/app/lib/controllers/utils/checkPermission", {
...
// ─── Converter mocks ─────────────────────────────────────────────────────────
mock.module("@/app/lib/controllers/utils/vehicleUtils", {
  namedExports: {
...
mock.module("@/app/lib/controllers/utils/trendUtils", {
  namedExports: {
    calcTrend: mock.fn(() => 0),
...
mock.module("@/app/lib/type/vehicle", {
  namedExports: {},
});
